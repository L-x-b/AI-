...
import com.yolo.aiQuiz.mapper.AppMapper;
import com.yolo.aiQuiz.model.dto.app.AppQueryRequest;
...
import com.yolo.aiQuiz.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(scoringStrategyEnum == null, ErrorCode.PARAMS_ERROR, "应用评分测策略类别不合法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
